"""Dashboard metrics calculated from data returned by the backend."""
...
def calculate_metrics(df: pd.DataFrame) -> Dict[str, Any]:
    ...
    evidence_compliance = len(df[df[evidence_column] == "Yes"]) / passed * 100 if passed and evidence_column else 0
